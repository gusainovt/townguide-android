...
fun AddPlaceScreen(
    ...
    val photoPicker = rememberLauncherForActivityResult(GetContent()) { uri ->
        ...
        LazyColumn(
            ...
            item {
                GlassPanel {
                    ...
                    Text(
                        text = "Выберите город, заполните карточку места и прикрепите фотографию.",
            ...
            if (selectedCity == null) {
                ...
                item {
                    GlassPanel {
                        ...
                        Text(
                            text = "Новое место для ${selectedCity!!.name}",
                        ...
                        GlassButton(
                            text = if (selectedImageUri == null) "Выбрать фотографию" else "Изменить фотографию",
                        ...
                        GlassButton(
                            text = if (submitting) "Сохраняем место" else "Создать место",
                            onClick = viewModel::onCreatePlaceClick,
                            modifier = Modifier.fillMaxWidth(),
                            enabled = !submitting,
                            loading = submitting
                        )
